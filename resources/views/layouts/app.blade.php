...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ asset(path: 'admin_assets/plugins/chartist/dist/chartist.min.css') }}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{ asset('admin_assets/css/style.min.css') }}" rel="stylesheet">

    <link href="{{ asset('adminlte/lteadmin.css') }}" rel="stylesheet">
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper m-0" style="min-height: 100vh !important">
            ...
            <!-- <div class="text-center">
                <img src="{{ asset('icons/logo-dark.png') }}" class="dark-logo" width="198px" alt="Laravel Roles & Permissions Manager">
            </div> -->
